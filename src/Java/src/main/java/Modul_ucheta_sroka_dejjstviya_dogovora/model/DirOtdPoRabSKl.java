 ...
 */
@Entity(name = "IISModul_ucheta_sroka_dejjstviya_dogovoraДирОтдПоРабСКл")
...
public class DirOtdPoRabSKl {
    ...
    public Integer getФамилия() {
      return фамилия;
    }

    public void setФамилия(Integer фамилия) {
