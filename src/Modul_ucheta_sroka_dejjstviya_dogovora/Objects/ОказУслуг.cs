...
namespace IIS.Modul_ucheta_sroka_dejjstviya_dogovora
{
    ...
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Договор fДоговор;
        
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Услуги fУслуги;
        
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Договор Договор
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Услуги Услуги
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ОказУслуг dataobject)
        {
