...
namespace IIS.Modul_ucheta_sroka_dejjstviya_dogovora
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Статус fСтатус;
        
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private double fДлительность;
        
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ЕдВремени fЕдВремени;
        
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Клиент fКлиент;
        
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ЕдВремени ЕдВремени
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ЕдВремени result = this.fЕдВремени;
        ...
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Статус Статус
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Статус result = this.fСтатус;
        ...
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Клиент Клиент
        {
            get
            {
                ...
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Modul_ucheta_sroka_dejjstviya_dogovora.Договор));
                }
            }
        }
    }
