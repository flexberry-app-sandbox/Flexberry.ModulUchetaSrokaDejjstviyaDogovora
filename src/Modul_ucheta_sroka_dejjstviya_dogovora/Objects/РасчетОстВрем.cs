...
namespace IIS.Modul_ucheta_sroka_dejjstviya_dogovora
{
    ...
    [View("РасчетОстВремE", new string[] {
            ...
            "Договор.Статус as \'Статус договора\'",
            "Договор.Длительность as \'Длительность договора\'",
    ...
    [View("РасчетОстВремL", new string[] {
            ...
            "Договор as \'Номер договора\'",
            "Договор.Статус",
            "Договор.Длительность as \'Длительность действия\'",
            "Договор.ЕдВремени as \'Единица времени\'",
            "Использовано as \'Использовано\'",
            "Доступно as \'Доступно\'"})]
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг fОказУслуг;
        ...
        public virtual IIS.Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг ОказУслуг
        {
            get
            {
                ...
                {
                    this.fОказУслуг = new IIS.Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг(this);
                }
                IIS.Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг result = this.fОказУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем));
                }
            }
        }
    }
