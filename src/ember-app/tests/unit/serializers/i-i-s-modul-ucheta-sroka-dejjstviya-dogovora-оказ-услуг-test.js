...
moduleForModel('i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-оказ-услуг', 'Unit | Serializer | i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-оказ-услуг', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-оказ-услуг',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
