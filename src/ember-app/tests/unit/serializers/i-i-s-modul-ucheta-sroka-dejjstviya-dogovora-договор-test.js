...
moduleForModel('i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-договор', 'Unit | Serializer | i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-договор', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-договор',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
