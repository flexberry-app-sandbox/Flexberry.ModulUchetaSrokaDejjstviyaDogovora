...
moduleForModel('i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-расчет-ост-врем', 'Unit | Serializer | i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-расчет-ост-врем', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-расчет-ост-врем',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
