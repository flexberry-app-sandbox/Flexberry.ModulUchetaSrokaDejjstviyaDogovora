...
moduleForModel('i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-клиент', 'Unit | Serializer | i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-клиент', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-клиент',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
